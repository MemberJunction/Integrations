# Microsoft Dynamics 365 (Dataverse) — Supported & Proven
...
**592 objects** declared across **17896 fields** (source: `metadata/integration/.microsoft-dynamics-365-dataverse.integration.json`). 518 declare a write path; 74 are read-only (pull). 459 support incremental sync.
...
| aciviewmapper | ✓ | `CUD` | ✓ |
| actioncard | ✓ | `CUD` | ✓ |
| actioncarduserstate | ✓ | `CUD` | — |
| activityfileattachment | ✓ | `CUD` | ✓ |
| activitymimeattachment | ✓ | `CUD` | — |
| activityparty | ✓ | — (read-only) | — |
| activitypointer | ✓ | — (read-only) | ✓ |
| adx_externalidentity | ✓ | `CUD` | ✓ |
| adx_invitation | ✓ | `CUD` | ✓ |
| adx_inviteredemption | ✓ | `CUD` | ✓ |
| adx_portalcomment | ✓ | `CUD` | ✓ |
| adx_setting | ✓ | `CUD` | ✓ |
| adx_webformsession | ✓ | `CUD` | ✓ |
| aicopilot | ✓ | `CUD` | ✓ |
| aicopilot_aiplugin | ✓ | — (read-only) | — |
| aiplugin | ✓ | `CUD` | ✓ |
| aipluginauth | ✓ | `CUD` | ✓ |
| aipluginconversationstarter | ✓ | `CUD` | ✓ |
| aipluginconversationstartermapping | ✓ | `CUD` | ✓ |
| aipluginexternalschema | ✓ | `CUD` | ✓ |
| aipluginexternalschemaproperty | ✓ | `CUD` | ✓ |
| aiplugingovernance | ✓ | `CUD` | ✓ |
| aiplugingovernanceext | ✓ | `CUD` | ✓ |
| aiplugininstance | ✓ | `CUD` | ✓ |
| aipluginoperation | ✓ | `CUD` | ✓ |
| aipluginoperationparameter | ✓ | `CUD` | ✓ |
| aipluginoperationresponsetemplate | ✓ | `CUD` | ✓ |
| aiplugintitle | ✓ | `CUD` | ✓ |

_First 30 of 592 objects shown, alphabetically. The full catalog is the metadata file cited above._
...
- **Coverage:** 0 of 592 declared objects have proven rows.
