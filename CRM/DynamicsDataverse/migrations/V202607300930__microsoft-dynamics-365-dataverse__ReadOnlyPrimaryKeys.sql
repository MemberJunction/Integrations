...
--     Microsoft documents PrimaryIdAttribute = `ribbonmetadatarowid` (Uniqueidentifier,
...
--     Microsoft documents PrimaryIdAttribute = `roletemplateprivilegeid` (Uniqueidentifier,
