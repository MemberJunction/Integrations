...
> **Evidence tier:** 🟡 Honest-NA (untested for a documented, non-defect reason)  ·  **Last verified:** 2026-07-03  ·  **Proof DB(s):** —
...
**28 objects** declared across **672 fields** (source: `metadata/integration/.fonteva.integration.json`). 28 declare a write path; 0 are read-only (pull). 28 support incremental sync.
...
| SalesOrder | ✓ | `CUD` | ✓ |
| SalesOrderLine | ✓ | `CUD` | ✓ |
| ScheduledPayment | ✓ | `CUD` | ✓ |
| ScheduledPaymentLine | ✓ | `CUD` | ✓ |
| Store | ✓ | `CUD` | ✓ |
| Subscription | ✓ | `CUD` | ✓ |
| SubscriptionLine | ✓ | `CUD` | ✓ |
| SubscriptionPlan | ✓ | `CUD` | ✓ |
| Term | ✓ | `CUD` | ✓ |
...
- **Coverage:** 0 of 28 declared objects have proven rows.
