...
export class GrowthZoneConnector extends BaseRESTIntegrationConnector {
     ...
     *
     * Recursion note: `DiscoverFieldsViaFetch` falls back to the UNCHANGED {@link DiscoverFields}
     * (cache-driven) when the read path can't run — never back into THIS method — so there is no
     * infinite recursion. This connector does NOT override `DiscoverFields` to call any ViaFetch/ViaStream.
     *
