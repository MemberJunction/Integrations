...
**196 objects** declared across **6008 fields** (source: `metadata/integration/.membersuite.integration.json`). 196 declare a write path; 0 are read-only (pull). 196 support incremental sync.

| Object | Pull | Push (C/U/D) | Incremental |
|---|---|---|---|
| abstracts | ✓ | `CUD` | ✓ |
| abstractstatuses | ✓ | `CUD` | ✓ |
| activities | ✓ | `CUD` | ✓ |
| activitystatuses | ✓ | `CUD` | ✓ |
| activitytypes | ✓ | `CUD` | ✓ |
| addresstypes | ✓ | `CUD` | ✓ |
| appeals | ✓ | `CUD` | ✓ |
| associationconfigurationcontainers | ✓ | `CUD` | ✓ |
| associationpolicys | ✓ | `CUD` | ✓ |
| associationroles | ✓ | `CUD` | ✓ |
| certificateaccesscredentials | ✓ | `CUD` | ✓ |
| certificationapplicationexams | ✓ | `CUD` | ✓ |
| certificationapplications | ✓ | `CUD` | ✓ |
| certificationcomponentregistrations | ✓ | `CUD` | ✓ |
| certificationcomponents | ✓ | `CUD` | ✓ |
| certificationcomponenttypes | ✓ | `CUD` | ✓ |
| certificationexams | ✓ | `CUD` | ✓ |
| certificationexamtypes | ✓ | `CUD` | ✓ |
| certificationfees | ✓ | `CUD` | ✓ |
| certificationprogramconfigurationsettings | ✓ | `CUD` | ✓ |
| certificationprograms | ✓ | `CUD` | ✓ |
| certificationrecommendations | ✓ | `CUD` | ✓ |
| certificationrecommendationtypes | ✓ | `CUD` | ✓ |
| certifications | ✓ | `CUD` | ✓ |
| certificationstatuses | ✓ | `CUD` | ✓ |
| certificationstatusreasons | ✓ | `CUD` | ✓ |
| ceucredits | ✓ | `CUD` | ✓ |
| ceutypes | ✓ | `CUD` | ✓ |
| chapterduesproducts | ✓ | `CUD` | ✓ |
| chapterpostalcodemappings | ✓ | `CUD` | ✓ |

_First 30 of 196 objects shown, alphabetically. The full catalog is the metadata file cited above._
...
- **Coverage:** 0 of 196 declared objects have proven rows.
