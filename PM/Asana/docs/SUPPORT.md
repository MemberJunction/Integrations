# Asana — Supported & Proven

> **Evidence tier:** 🟢 Live-vendor (real API + real account)  ·  **Last verified:** 2026-08-05  ·  **Proof DB(s):** —

> 🟢 **Run live through AIDP against Blue Cypress's own Asana workspace.** This connector has synced data from the
...
**4 objects** declared across **57 fields** (source: `metadata/integration/.asana.integration.json`). 0 declare a write path; 4 are read-only (pull). 1 supports incremental sync.
