...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM __mj."IntegrationObjectField" WHERE "IntegrationObjectID" = 'E397FE85-9B83-40CE-A922-32525081EC4D' AND "Name" = 'sessions_information'
    ) THEN
...
--   `@Length_<hash> INTEGER`, never assigns it, and passes `@Length_Clear = 1`. Verified against
