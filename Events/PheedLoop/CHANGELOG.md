...
- 4b7d1e4: Repair `Speakers.sessions_information` — guard on the key the unique constraint actually uses.
...
- 3656861: PheedLoop connector: declare a rate-limit policy, and stop bounding free-text fields.
